...
const FIELD_META: Record<string, Record<string, FieldDef>> = {
    ...
    "Select Field": {
        ...
        fieldKey:    { label: "ชื่อตัวแปร",               type: "text",   section: "data", hint: "ชื่อสำหรับสิ่งที่เลือก — ใช้เมื่อกดปุ่มส่งข้อมูล เช่น ตั้งเป็น 'material' ค่าที่เลือกจะถูกส่งในชื่อ material", placeholder: "เช่น material", suggestions: FIELD_KEY_SUGGESTIONS, showWhen: { field: "dataSource", value: "static" } },
