...
const FIELD_META: Record<string, Record<string, FieldDef>> = {
    ...
    "QR Scan": {
        ...
        dataSource:     { label: "แหล่งข้อมูล",             type: "select", section: "data",  options: ["/orders", "/requests", "/panes", "/panes/scan"], optionLabels: ["รายการออเดอร์", "รายการคำขอ (บิล)", "รายการกระจก (Pane)", "สแกน Pane เข้าสถานี"], hint: "บล็อกจะค้นหาข้อมูลจากแหล่งนี้เมื่อสแกน QR สำเร็จ — ใช้ '/panes/scan' สำหรับสแกนกระจกผ่านสถานี (scan_in → start → complete)" },
    ...
    "Record List": {
        ...
        pendingPanesOnly:       { label: "ซ่อนออเดอร์ที่สแกนเข้าครบแล้ว", type: "toggle", section: "data", hint: "ใช้คู่กับ 'คิวสถานีนี้' — ออเดอร์จะหายไปจากรายการเมื่อกระจกทุกชิ้นในออเดอร์นั้นสแกนเข้าสถานีครบแล้ว" },
